...
Original writing design; implemented article and demo: [review](../../platform-demos-review.md). ID: `astro` · Group: [static-generators](../groups/static-generators.md) · Queue order: 700 · Checked: 2026-09-22.
...
| -------------------------------------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------ | ---------- |
| [astro](https://docs.astro.build/en/concepts/why-astro/) | Features; Content-driven; Server-first | [Verified claim and context](../sources.md#astro); apply only to this mechanism, not general rankings. | 2026-09-22 |
