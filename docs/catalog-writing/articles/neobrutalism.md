...
Writing design only. ID: `neobrutalism` · Group: [styles](../groups/styles.md) · Queue order: 1 · Checked: 2026-09-21.

## Reader question and scope

**Question:** What distinguishes bold outlined cards from raw web brutalism?

**Include:** Explain thick outlines, hard offset shadows and expressive color while preserving reading hierarchy.

**Exclude:** Universal rules, origin ownership and guaranteed engagement.

**Prevent confusion:** Hard shadows differ from soft extrusion; raw and colorful are not synonyms.

**Terms (EN / KO / JA):** Neobrutalism / 네오브루탈리즘 / ネオブルータリズム; Hard shadow / 단단한 그림자 / 硬い影. Also use the [group terms](../groups/styles.md) and [shared glossary](../glossary.md). These are editorial translations, not claims of standardized terminology.

## Six-section article outline

### 1. Definition

Open by answering the reader question. Establish this boundary: Explain thick outlines, hard offset shadows and expressive color while preserving reading hierarchy. Explain the distinguishing mechanism: Graphic outlines and hard offset depth [style-neo]. Immediately separate the nearby concept: Hard shadows differ from soft extrusion; raw and colorful are not synonyms.
...
Input: shared card. Initial: neutral. Action: apply 3px outline and 4px hard shadow, then save. Result: Saved state with graphic framing; dimensions are illustration choices.

### 3. Advantages and limitations

Explain the conditional benefit: The proposed outline gives Save a distinct boundary. Then show its boundary: Equally loud elements compete; emphasize the main action in this example. Use the unsuitable case below as a counterexample; do not turn editorial advice into an empirical performance or usability result.

### 4. Comparison within the category

Compare every sibling: [brutalism](brutalism.md), [glassmorphism](glassmorphism.md), [neumorphism](neumorphism.md), [skeuomorphism](skeuomorphism.md), [flat-design](flat-design.md), [minimalism](minimalism.md).
...
**Suitable:** A playful publication with a graphic identity.

**Unsuitable:** A dense workspace with equal emphasis on every control.

**Combine:** Use minimal content and a uniform grid; reserve accents for named roles.
...
| Field          | Planned point                                                             |
| -------------- | ------------------------------------------------------------------------- |
| `features`     | Graphic outlines and hard offset depth [style-neo].                       |
| `advantages`   | The proposed outline gives Save a distinct boundary.                      |
| `limitations`  | Equally loud elements compete; emphasize the main action in this example. |
| `suitable`     | A playful publication with a graphic identity.                            |
| `combinations` | Use minimal content and a uniform grid; reserve accents for named roles.  |
...
**Purpose:** Answer “What distinguishes bold outlined cards from raw web brutalism?” through the fixture rather than a decorative illustration.
...
**Interaction/state script:** Input: shared card. Initial: neutral. Action: apply 3px outline and 4px hard shadow, then save. Result: Saved state with graphic framing; dimensions are illustration choices.

**Annotations, caption and topic acceptance:** Label border, offset and accent. Caption: Graphic emphasis changes; action stays. Accept if outline and focus remain distinct in grayscale.
