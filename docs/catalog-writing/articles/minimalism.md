# Minimalism / 미니멀리즘 / ミニマリズム

Writing design only. ID: `minimalism` · Group: [styles](../groups/styles.md) · Queue order: 6 · Checked: 2026-09-21.

## Reader question and scope

**Question:** What can disappear without removing the reading task?

**Include:** Explain task-based reduction of decoration and redundancy while retaining title, summary, metadata and Save.

**Exclude:** Lifestyle minimalism, mandatory monochrome and universal element counts.

**Prevent confusion:** Content selection is different from flat surface treatment.

**Terms (EN / KO / JA):** Minimalism / 미니멀리즘 / ミニマリズム; Negative space / 여백 / 余白. Also use the [group terms](../groups/styles.md) and [shared glossary](../glossary.md). These are editorial translations, not claims of standardized terminology.

## Six-section article outline

### 1. Definition

Open by answering the reader question. Establish this boundary: Explain task-based reduction of decoration and redundancy while retaining title, summary, metadata and Save. Explain the distinguishing mechanism: Remove elements that do not serve the task [style-min]. Immediately separate the nearby concept: Content selection is different from flat surface treatment.
...
Input: shared card plus decorative badges and duplicate Save. Initial: all shown. Action: remove badges and duplicate action. Result: every unique fact and original Save remain.

### 3. Advantages and limitations

Explain the conditional benefit: The proposed card gives title and Save fewer competing decorations. Then show its boundary: Excessive removal erases necessary context and controls [style-min-cross]. Use the unsuitable case below as a counterexample; do not turn editorial advice into an empirical performance or usability result.
...
**Suitable:** A clear task surrounded by redundant ornament.

**Unsuitable:** A workflow stripped of required instructions.

**Combine:** Combine with flat, glass or raw surfaces according to context.
...
| Field          | Planned point                                                              |
| -------------- | -------------------------------------------------------------------------- |
| `features`     | Remove elements that do not serve the task [style-min].                    |
| `advantages`   | The proposed card gives title and Save fewer competing decorations.        |
| `limitations`  | Excessive removal erases necessary context and controls [style-min-cross]. |
| `suitable`     | A clear task surrounded by redundant ornament.                             |
| `combinations` | Combine with flat, glass or raw surfaces according to context.             |
...
| -------------------------------------------------------------------------------- | ---------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------- |
| [style-min](https://www.nngroup.com/articles/characteristics-minimalism/)        | Opening definition; Flat Patterns and Textures | [Verified claim and context](../sources.md#style-min); apply only to this mechanism, not general rankings.       | 2026-09-21 |
| [style-min-cross](https://www.nngroup.com/articles/aesthetic-minimalist-design/) | Minimalist Design, Maximum Utility             | [Verified claim and context](../sources.md#style-min-cross); apply only to this mechanism, not general rankings. | 2026-09-21 |
...
**Purpose:** Answer “What can disappear without removing the reading task?” through the fixture rather than a decorative illustration.
...
**Interaction/state script:** Input: shared card plus decorative badges and duplicate Save. Initial: all shown. Action: remove badges and duplicate action. Result: every unique fact and original Save remain.

**Annotations, caption and topic acceptance:** Number retained and removed elements; mark a version missing Save as rejected. Caption: Reduce redundancy, preserve task. Accept if each removal has a stated non-task reason.
