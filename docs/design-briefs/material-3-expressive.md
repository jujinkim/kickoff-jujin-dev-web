...
- Distinct familiar situation, dataset, labels, actions, and initial state for this article: For the community picnic, track three tasks and two notes.
...
- Fictional scenario and why it demonstrates the definition: A picnic planner must make the next organizing action easy to find. For the community picnic, track three tasks and two notes.
- Representative action and observable result: For the community picnic, track three tasks and two notes. Mark one task: progress becomes 1 / 3 and 33%.
