...
- Distinct familiar situation, dataset, labels, actions, and initial state for this article: For the clinic visit, track three tasks and two notes.
...
- Fictional scenario and why it demonstrates the definition: A clinic booking screen needs clear actions without decorative shadows. For the clinic visit, track three tasks and two notes.
- Representative action and observable result: For the clinic visit, track three tasks and two notes. Mark one task: progress becomes 1 / 3 and 33%.
