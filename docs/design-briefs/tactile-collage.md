...
- Fictional scenario and why it demonstrates the definition: A small project workspace gives every style the same navigation, content, controls and supporting information to render. A board of layered papers, tape and annotations. Paper offsets stay inside the board; reading order remains overview, tasks, progress, resources.
