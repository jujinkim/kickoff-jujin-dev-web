...
- Fictional scenario and why it demonstrates the definition: controller maps IDs → SaveArticle → SavedArticle validates → SaveRepository dispatches to adapter → plain Saved result. Dependency and call directions are separate relations; logical boundaries do not prescribe deployment topology.
