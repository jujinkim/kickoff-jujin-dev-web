...
- Fictional scenario and why it demonstrates the definition: presentation → application → persistence; Saved returns upward. Dependency and call directions are separate relations; logical boundaries do not prescribe deployment topology.
