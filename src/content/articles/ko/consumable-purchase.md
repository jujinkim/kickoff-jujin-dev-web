...
가상 퍼즐 앱의 힌트는 처음에 0개입니다. 3개를 구매하고 반복 사용하면 잔액이 0까지 줄고 추가 사용이 차단됩니다. 다시 묶음을 구매하면 3개가 추가됩니다. 페이지 안의 가상 예제로 실제 구매는 처리하지 않습니다. 가격·세금·수수료·환불은 생략했으며 초기화·새로고침은 예제를 지웁니다.

## 추천 조건

반복해서 소비할 선택적 가치에 적합합니다. 무료 접근과 조합하면서 잔액과 지출을 명확히 보여주세요.
