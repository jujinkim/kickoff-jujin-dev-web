...
구매한 기능을 반복해서 써도 계속 이용할 수 있어야 합니다. 쓸 때마다 수량을 차감하면 그 약속과 맞지 않습니다.

## 어떻게 해결하는가

가상 퍼즐 앱의 야간 테마는 처음에 잠겨 있습니다. 한 번 구매하고 반복 적용해도 소유 권한은 유지되고 구매 횟수는 1입니다. 이 예제에서 재구매 시도는 다시 청구하지 않습니다. 실제 구매 복원은 구현 범위 밖입니다. 가격·세금·수수료·환불은 생략했으며 초기화는 예제만 지웁니다.
