...
승객이 노선과 시간을 빠르게 읽는 교통 안내 화면을 만든다고 가정해 봅시다. 편집자는 인쇄물 같은 분위기보다 담백한 글자 형태를 택하되, 비슷한 표지가 구별되는지도 확인해야 합니다.
...
산세리프는 세리프 장식이 없지만 획 끝과 비율은 다양합니다.

보편적인 가독성을 가정하지 말고 유사 글자와 한·일 서브셋을 확인하세요.
