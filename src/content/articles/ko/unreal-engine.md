...
도식에는 플레이어·바닥·카메라·동전 액터 하나가 있습니다. 아이템으로 이동을 누르면 작성한 겹침 검사가 점수를 0에서 1로 바꾸고 액터를 제거합니다. 다시 접촉해도 점수는 오르지 않습니다. 이동 전에 접촉 끄기를 선택하면 수집 실패로 점수는 0입니다. 초기화·새로고침은 처음 상태를 복원합니다. 실제 엔진이 아닌 개념 시뮬레이션입니다.
