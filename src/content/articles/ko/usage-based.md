...
가벼운 사용자와 많은 사용자의 자원 소비가 크게 다릅니다. 같은 금액을 받으면 가치나 운영비 차이를 반영하지 못합니다.

## 어떻게 해결하는가

가상 내보내기 도구가 회당 0.02를 청구합니다. 월 100·300·600회라면 2·6·12, 합계 20입니다. 첫 달 사용량을 바꾸거나 1회 추가하면 해당 월 요금과 합계가 변합니다. 이 예제에서 사용량 0은 요금도 0입니다. 세금·수수료·환불은 생략했습니다.
