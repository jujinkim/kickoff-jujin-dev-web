...
架空の読書サービスが読者から12を受け取り、アクセスを提供します。図は支払いとコンテンツ提供を分けます。決済処理を担当しても販売者になるとは限りません。金額は架空で、税金・処理手数料・返金は省略しています。

## 選ぶ条件

顧客が支払う価値を感じる製品に適します。継続課金や買い切りと組み合わせ、アクセス条件は別に定めます。
