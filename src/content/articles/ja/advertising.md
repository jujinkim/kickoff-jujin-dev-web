...
架空の読書サービスが記事を無料公開します。広告主はネットワーク経由で明示された広告枠に支払い、発行者は場所を提供し、読者は広告を見ます。図は役割を示し、表示回数・クリック・収入は保証しません。精算の詳細と手数料は省略しています。

## 選ぶ条件

広告枠が読書体験に合う場合に適します。広告主の意向と読者の信頼を考慮し、バナー・インタースティシャル・リワードを別に比較します。
