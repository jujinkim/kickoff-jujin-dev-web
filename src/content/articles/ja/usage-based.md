...
少量利用と大量利用では消費する資源が大きく異なります。同じ請求額では価値や運営費の差を表しにくくなります。

## どう解決するのか

架空の出力ツールは1回0.02です。月100・300・600回なら2・6・12、合計20です。1か月目の利用量を変えるか1回追加すると、その月の料金と合計が変わります。この例では利用量0なら料金も0です。税金・手数料・返金は省略しています。
