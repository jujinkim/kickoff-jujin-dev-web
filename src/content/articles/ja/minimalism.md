...
補助的な装飾が、利用者の本来の作業と視線を奪い合います。必要な操作を残しながら主要な情報へ集中させたい場面です。

## どう解決するのか

作業三件とメモ二件の画面で一件を完了すると、進捗は1 / 3、33%になります。絞り込みやメモ展開を試し、リセットで初期状態と比べます。余白と控えめな文字でプロジェクト情報を読みやすく配置します。
